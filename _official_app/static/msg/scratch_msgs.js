...
Blockly.ScratchMsgs.locales["en"] =
{
    ...
    "OPERATORS_LETTEROF": " %2 Counts the %1 character from left to right ",
    ...
    "CATEGORY_SENSOR": "Sensor 1",
    "CATEGORY_SENSOR_TWO": "Sensor 2",
    ...
    //主控器
    "EVENT_X35J_BEGIN": "When the IE1500 main controller starts",
    "EVENT_M40D_BEGIN": "When the IE1 main controller starts",
    "ROBOT_MOTOR": "Drive %1 motor to rotate at %2 speed",
    "ROBOT_TELECONTROL": "Read remote control channel %1",
    "ROBOT_SERIAL_PORT": "serial output %1 in %2 %3",
    "ROBOT_SERIAL_PORT_STRING": "serial string output %1 %2",
    "ROBOT_SERIAL_PORT_INT": "serial int output %1 %2",
    "ROBOT_SERIAL_PORT_FLOAT": "serial float output %1 %2",
    "ROBOT_STRING": "string",
    "ROBOT_NUMBER": "number",
    "ROBOT_FLOAT": "float",
    "ROBOT_WRAP": "wrap",
    "ROBOT_NO_WRAP": "no-wrap",
    "ROBOT_STEERING_ENGINE": "Set servo %1 to %2 degrees",
    "MOTION_TEST": " %1 测试",
    // 传感器块名 一
    "SENSE_INERTIA_MOTION_INITIALIZE": "BMM169 initialization address %1",
    "SENSE_X_ACCELERATED_SPEED": "BMI 160 obtains the x axis velocity value(g)",
    "SENSE_Y_ACCELERATED_SPEED": "BMI 160 obtains the y axis velocity value(g)",
    "SENSE_Z_ACCELERATED_SPEED": "BMI 160 obtains the z axis velocity value(g)",
    "SENSE_X_AXIAL_ANGLE": "BMI 160 obtains x axis angular velocity(dps)",
    "SENSE_Y_AXIAL_ANGLE": "BMI 160 obtains y axis angular velocity(dps)",
    "SENSE_Z_AXIAL_ANGLE": "BMI 160 obtains z axis angular velocity(dps)",
    "SENSE_XYZ_GEOMAGNETISM_INITIALIZE": "BMM150 initialization address %1",
    "SENSE_GEOMAGNETISM_DEFLECTION": "Obtain geomagnetic declination angle(°)",
    "SENSE_COLOURS_LCD_INITIALIZE": "LCD1602 Initialization R=%1 G=%2 B=%3 brightness=%4",
    "SENSE_LCD_PORT_SHOW_STRING": "line %1, column %2 of the display screen starts displaying strings numbers %3",
    "SENSE_LCD_PORT_SHOW_NUMBER": "line %1, column %2 of the display screen starts displaying integers numbers %3",
    "SENSE_LCD_PORT_SHOW_FLOAT": "line %1, column %2 of the display screen starts displaying floating-point numbers %3",
    "SENSE_LCD_PORT_CLEAR_DATA": "Clear display screen content",
    "SENSE_OID_MODULE_INITIALIZE": "Ground Identification Module initialization",
    "SENSE_OID_GET_X_COORDINATES": "Read the x-axis coordinates of the current position",
    "SENSE_OID_GET_Y_COORDINATES": "Read the y-axis coordinates of the current position",
    "SENSE_OID_GET_ANGLE": "Read the angle value corresponding to the current position",
    "SENSE_OID_GET_CODE": "Read the code point number to the current position ",
    "SENSE_OID_GET_IS_UPLIFT": "The ground recognition sensors did not recognize the code point?",
    // 传感器标题 一
    "SENSE_INERTIA_MOTION_LABEL": "(SEN0250) BMI 160 6-axis inertial motion sensor",
    "SENSE_XYZ_GEOMAGNETISM_LABEL": "(SEN0529) BMM150 Three Axis Geomagnetic Sensor",
    "SENSE_COLOURS_LCD_LABEL": "(DFR0464) ICD1602 RGB color backlight LCD screen",
    "SENSE_IIC_INTERFACE_LABEL": "(DFR0555) LCD1602 module IIC interface",
    "SENSE_OID_MODULE_LABEL": "(XZS001)Ground Identification Module",
    // 传感器块名 二
    "SENSE_LED": "%1 %2 LED",
    "SENSE_BREATHE_LED": "LED breathes in %1 ms cycles",
    "SENSE_BUTTON_DOWN": "Has the button been pressed for at least %1 ms? ",
    "SENSE_TEMPERATURE": "Read LM35 temperature(℃)",
    "SENSE_ROTATION_ANGLE": "Reading angle(°)",
    "SENSE_CERAMIC_SHAKE": "Read the vibration force value",
    "SENSE_HUMAN_BODY": "Detected human or animal？",
    "SENSE_FLAME": "Read flame value parameters",
    "SENSE_SOUND": "Reading sound intensity",
    "SENSE_ELECTROMAGNETIC": "Detected magnet？",
    "SENSE_TOUCH": "Touch detected？",
    "SENSE_SHAKE": "When the sensor detects vibration",
    "SENSE_GRAY_VALUE": "Read grayscale values",
    "SENSE_CARBONIC_OXIDE": "Reading the parameters of carbon monoxide gas volume",
    "SENSE_VOLTAGE": "Read voltage value(V)",
    "SENSE_SOIL_HUMIDITY": "Reading soil moisture parameter values",
    "SENSE_SLANT": "Tilt detected？",
    "SENSE_RELAY": "%1 Relay",
    "SENSE_TWO_ULTRASONIC": "Reading distance(cm)",
    "SENSE_ULTRASONIC": "Reading distance(cm)",
    // 传感器标题 二
    "SENSE_LED_LABEL": "(DFR0021)Digital LED light emitting module",
    "SENSE_NUMBIGBUTTON_LABEL": "(DFR0029)Digital large button module",
    "SENSE_TEMPERATURE_LABEL": "(DFR0023)LM35 Analog Linear Temperature Sensor",
    "SENSE_ROTATION_ANGLE_LABEL": "(DFR0058)Analog multi turn rotation angle sensor",
    "SENSE_CERAMIC_SHAKE_LABEL": "(DFR0052)Analog Piezoelectric Ceramic Vibration Sensor",
    "SENSE_HUMAN_BODY_LABEL": "(SEN0018)Digital Human Infrared Pyroelectric Motion Sensor",
    "SENSE_FLAME_LABEL": "(DFR0076)Flame sensor",
    "SENSE_SOUND_LABEL": "(DFR0034)Analog Sound Sensor",
    "SENSE_ELECTROMAGNETIC_LABEL": "(DFR0033)Digital Chip Magnetic Induction Sensor",
    "SENSE_TOUCH_LABEL": "(DFR0030)Digital Touch Sensor",
    "SENSE_SHAKE_LABEL": "(DFR0027)Digital Vibration Sensor",
    "SENSE_GRAY_VALUE_LABEL": "(DFR0022)Analog grayscale sensor",
    "SENSE_CARBONIC_OXIDE_LABEL": "(SEN0132)Digital Chip Magnetic Induction Sensor",
    "SENSE_VOLTAGE_LABEL": "(DFR0051)Analog voltage detection module",
    "SENSE_SOIL_HUMIDITY_LABEL": "(SEN0114)Soil Moisture Sensor",
    "SENSE_SLANT_LABEL": "(DFR0028)Digital Steel Ball Tilt Sensor",
    "SENSE_RELAY_LABEL": "(DFR0017)Digital Relay Module",
    "SENSE_ULTRASONIC_LABEL": "(SEN0307)Analog Ultrasonic Sensor",
    "SENSE_ULTRASONIC_TWO_LABEL": "(XZ0002)Ultrasonic sensors",
    // common
    "SENSE_ON": "on",
    "SENSE_OFF": "off",
};

Blockly.ScratchMsgs.locales["cn"] =
{
    ...
    "EVENT_WHENARDUINOBEGIN": "当 x30j机器人 启动",
    ...
    "SOUND_RECORD": "录制…",
    "CATEGORY_ROBOT": "机器人",
    "CATEGORY_SENSOR": "传感器1",
    "CATEGORY_SENSOR_TWO": "传感器2",
    "CATEGORY_EVENTS": "事件",
    "CATEGORY_CONTROL": "控制",
    "CATEGORY_SENSING": "侦测",
    ...
    //主控器
    "EVENT_X35J_BEGIN": "当 IE1500主控器 启动",
    "EVENT_M40D_BEGIN": "当 IE1主控器 启动",
    "ROBOT_MOTOR": "驱动 %1 电机以 %2 速度旋转",
    "ROBOT_TELECONTROL": "读取遥控器通道 %1",
    "ROBOT_SERIAL_PORT_STRING": "串口 字符串 输出 %1 %2",
    "ROBOT_SERIAL_PORT_INT": "串口 整数 输出 %1 %2",
    "ROBOT_SERIAL_PORT_FLOAT": "串口 浮点数 输出 %1 %2",
    "ROBOT_STRING": "字符串",
    "ROBOT_NUMBER": "整数",
    "ROBOT_FLOAT": "浮点",
    "ROBOT_WRAP": "换行",
    "ROBOT_NO_WRAP": "不换行",
    "ROBOT_STEERING_ENGINE": "设置舵机 %1 为 %2 度",
    "MOTION_TEST": " %1 测试",
    // 传感器块名 一
    "SENSE_INERTIA_MOTION_INITIALIZE": "BMM160初始化 地址 %1",
    "SENSE_X_ACCELERATED_SPEED": "BMI160获取x轴加速度值(g)",
    "SENSE_Y_ACCELERATED_SPEED": "BMI160获取y轴加速度值(g)",
    "SENSE_Z_ACCELERATED_SPEED": "BMI160获取z轴加速度值(g)",
    "SENSE_X_AXIAL_ANGLE": "BMI160获取x轴角速度(dps)",
    "SENSE_Y_AXIAL_ANGLE": "BMI160获取y轴角速度(dps)",
    "SENSE_Z_AXIAL_ANGLE": "BMI160获取z轴角速度(dps)",
    "SENSE_XYZ_GEOMAGNETISM_INITIALIZE": "BMM150初始化 地址 %1",
    "SENSE_GEOMAGNETISM_DEFLECTION": "获取地磁偏角(°)",
    "SENSE_COLOURS_LCD_INITIALIZE": "LCD1602 初始化 R = %1 G = %2 B = %3 亮度 = %4",
    "SENSE_LCD_PORT_SHOW_STRING": "显示屏从第 %1 行的第 %2 列开始显示字符串 %3",
    "SENSE_LCD_PORT_SHOW_NUMBER": "显示屏从第 %1 行的第 %2 列开始显示整数 %3",
    "SENSE_LCD_PORT_SHOW_FLOAT": "显示屏从第 %1 行的第 %2 列开始显示浮点数 %3",
    "SENSE_LCD_PORT_CLEAR_DATA": "清空显示屏内容",
    "SENSE_OID_MODULE_INITIALIZE": "地面识别模块初始化",
    "SENSE_OID_GET_X_COORDINATES": "读取当前位置x轴坐标",
    "SENSE_OID_GET_Y_COORDINATES": "读取当前位置y轴坐标",
    "SENSE_OID_GET_ANGLE": "读取当前位置对应角度数值",
    "SENSE_OID_GET_CODE": "读取当前位置码点编号",
    "SENSE_OID_GET_IS_UPLIFT": "地面识别模块未识别到码点?",
    // 传感器标题 一
    "SENSE_INERTIA_MOTION_LABEL": "(SEN0250)BMI160 6轴惯性运动传感器",
    "SENSE_XYZ_GEOMAGNETISM_LABEL": "(SEN0529)BMM150 三轴地磁传感器",
    "SENSE_COLOURS_LCD_LABEL": "(DFR0464)I2C LCD1602 RGB 彩色背光液晶屏",
    "SENSE_IIC_INTERFACE_LABEL": "(DFR0555)LCD1602模块 IIC接口",
    "SENSE_OID_MODULE_LABEL": "(XZS001)地面识别模块",
    // 传感器块名 二
    "SENSE_LED": "%1 %2 LED",
    "SENSE_BREATHE_LED": "LED以 %1 ms为一个周期呼吸",
    "SENSE_BUTTON_DOWN": "按钮至少被按下 %1 ms？ ",
    "SENSE_TEMPERATURE": "读取LM35温度(℃)",
    "SENSE_ROTATION_ANGLE": "读取角度(°)",
    "SENSE_CERAMIC_SHAKE": "读取震动力度值",
    "SENSE_HUMAN_BODY": "检测到人或动物？",
    "SENSE_FLAME": "读取火焰值参数",
    "SENSE_SOUND": "读取声音强度",
    "SENSE_ELECTROMAGNETIC": "检测到磁铁？",
    "SENSE_TOUCH": "检测到触摸？",
    "SENSE_SHAKE": "当传感器检测到震动时",
    "SENSE_GRAY_VALUE": "读取灰度值",
    "SENSE_CARBONIC_OXIDE": "读取一氧化碳气体量参数",
    "SENSE_VOLTAGE": "读取电压值(V)",
    "SENSE_SOIL_HUMIDITY": "读取土壤湿度参数值",
    "SENSE_SLANT": "检测到倾斜？",
    "SENSE_RELAY": "%1 继电器",
    "SENSE_TWO_ULTRASONIC": "读取距离(cm)",
    "SENSE_ULTRASONIC": "读取距离(cm)",
    // 传感器标题 二
    "SENSE_LED_LABEL": "(DFR0021)数字LED发光模块",
    "SENSE_NUMBIGBUTTON_LABEL": "(DFR0029)数字大按钮模块",
    "SENSE_TEMPERATURE_LABEL": "（DFR0023)LM35模拟线性温度传感器",
    "SENSE_ROTATION_ANGLE_LABEL": "(DFR0058)模拟多圈旋转角度传感器",
    "SENSE_CERAMIC_SHAKE_LABEL": "(DFR0052)模拟压电陶瓷震动传感器",
    "SENSE_HUMAN_BODY_LABEL": "(SEN0018)数字人体红外热释电运动传感器",
    "SENSE_FLAME_LABEL": "(DFR0076)火焰传感器",
    "SENSE_SOUND_LABEL": "(DFR0034)模拟声音传感器",
    "SENSE_ELECTROMAGNETIC_LABEL": "(DFR0033)数字贴片磁感应传感器",
    "SENSE_TOUCH_LABEL": "(DFR0030)数字触摸传感器",
    "SENSE_SHAKE_LABEL": "(DFR0027)数字震动传感器",
    "SENSE_GRAY_VALUE_LABEL": "(DFR0022)模拟灰度传感器",
    "SENSE_CARBONIC_OXIDE_LABEL": "(SEN0132)模拟一氧化碳气体传感器",
    "SENSE_VOLTAGE_LABEL": "(DFR0051)模拟电压检测模块",
    "SENSE_SOIL_HUMIDITY_LABEL": "(SEN0114)土壤湿度传感器",
    "SENSE_SLANT_LABEL": "(DFR0028)数字钢球倾角传感器",
    "SENSE_RELAY_LABEL": "(DFR0017)数字继电器模块",
    "SENSE_ULTRASONIC_LABEL": "(SEN0307)模拟超声波传感器",
    "SENSE_ULTRASONIC_TWO_LABEL": "(XZ0002)超声波传感器",
    // common
    "SENSE_ON": "开",
    "SENSE_OFF": "关",
};
